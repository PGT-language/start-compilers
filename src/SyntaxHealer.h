...
private:
    ...
    {
        return {
            {"web", "route"}, {"web", "get"}, {"web", "post"}, {"web", "serve"}, {"web", "run"}, {"net", "get"}, {"net", "post"}, {"net", "serve"}, {"net", "run"}, {"log", "output"}, {"log", "set_output"}, {"log", "console"}, {"log", "file"}, {"log", "trace"}, {"log", "debug"}, {"log", "info"}, {"log", "notice"}, {"log", "warn"}, {"log", "warning"}, {"log", "error"}, {"log", "critical"}, {"log", "critecal"}, {"log", "fatal"}, {"json", "parse"}, {"json", "decode"}, {"json", "unmarshal"}, {"json", "stringify"}, {"json", "encode"}, {"json", "marshal"}, {"json", "write"}, {"json", "save"}, {"json", "read"}, {"json", "get"}, {"json", "object"}, {"auth", "hash_password"}, {"auth", "verify_password"}, {"jwt", "sign"}, {"jwt", "verify"}, {"sql", "open"}, {"sql", "connect"}, {"sql", "exec"}, {"sql", "table"}, {"sql", "insert"}, {"sql", "find"}, {"orm", "table"}, {"orm", "migrate"}, {"orm", "save"}, {"orm", "find"}, {"request", "method"}, {"request", "path"}, {"request", "body"}, {"request", "json"}, {"create", "file"}, {"write", "file"}, {"read", "file"}, {"close", "file"}, {"delete", "file"}};
    }
