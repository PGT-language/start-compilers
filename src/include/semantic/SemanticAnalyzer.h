...
enum class VarType { INT, FLOAT, STRING, BOOL, BYTES, OBJECT, ARRAY, UNKNOWN };
...
struct VariableInfo {
  ...
  VariableInfo(VarType t = VarType::UNKNOWN,
...
struct FunctionInfo {
  ...
  FunctionInfo(const std::vector<VarType> &params = {},
...
class SemanticAnalyzer {
  ...
  void enter_scope();
  void exit_scope();
  void declare_variable(const std::string &name, VarType type,
